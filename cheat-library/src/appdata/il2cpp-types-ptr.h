...
DO_TYPEDEF(0x09E12C08, Byte);
DO_TYPEDEF(0x09E25B40, GameManager);
DO_TYPEDEF(0x09E12AF8, Int32);

// v 2.8.54
DO_TYPEDEF(0x09E31840, LCChestPlugin);
DO_TYPEDEF(0x09E22A18, SceneTreeObject);
DO_TYPEDEF(0x09E397E0, MoleMole_ActorModifier);
